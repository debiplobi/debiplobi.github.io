...
export function ThemeToggle() {
    ...
    useEffect(() => {
        if (theme === "system") {
            ...
            document.documentElement.classList[isSystemDark ? "add" : "remove"]("dark");
        } else {
    ...
    return (
        <div className="flex items-center gap-1 border border-border/50 rounded-full p-1 bg-card/50 backdrop-blur-md shadow-sm">
            <button
                ...
                className={`p-2 rounded-full transition-[background-color,box-shadow] duration-300 ${theme === "light"
            ...
            <button
                ...
                className={`p-2 rounded-full transition-[background-color,box-shadow] duration-300 ${theme === "system"
                    ? "bg-background shadow-sm text-primary"
                    : "text-muted-foreground hover:text-foreground hover:bg-muted/50"
                    }`}
            ...
            <button
                ...
                className={`p-2 rounded-full transition-[background-color,box-shadow] duration-300 ${theme === "dark"
                    ? "bg-background shadow-sm text-primary"
                    : "text-muted-foreground hover:text-foreground hover:bg-muted/50"
                    }`}
